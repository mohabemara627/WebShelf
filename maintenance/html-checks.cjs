...
function checkScripts(html, page) {
  ...
  const ordinary = new Set(['index.html','activity.html','category.html','collection.html','suggest.html','support.html']);
  if (page !== '404.html') expected.push(ordinary.has(page) ? page.replace(/\.html$/, '.bundle.js') : 'category.bundle.js');
