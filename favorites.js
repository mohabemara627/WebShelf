...
function renderFavorites() {
  ...
  const rows = visible.map((site, index) => {
    ...
    return `
      <div class="site-row favorite-site-row" data-site-url="${site.url}">
        ...
        <button class="favorite-button active" type="button" data-site-url="${site.url}" aria-label="Remove from favorites">★</button>
      </div>`;
  }).join("");
